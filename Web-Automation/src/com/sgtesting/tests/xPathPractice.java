...
public class xPathPractice {
	...
	{ 
		try
		{
			oBrowser.get("file:///E:/Softwares/ExampleAutomation/Automation/Sample.html");
			Thread.sleep(3000);
		}
		catch(Exception e)
		{
	...
	static void relativeXPathUsingTagNameAlone()
	{
		try
		{
			oBrowser.findElement(By.xpath("//input")).sendKeys("Tagname");
		}
		catch(Exception e)
		{
			e.printStackTrace();
	...
	static void relativeXPathUsingTagNameAndIndex()
	{
		try
		{
			oBrowser.findElement(By.xpath("//input[2]")).sendKeys("TagNameIndex");
		}
		catch(Exception e)
		{
			e.printStackTrace();
