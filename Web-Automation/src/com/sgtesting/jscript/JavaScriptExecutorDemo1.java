...
//		slectItemFromDropDown();
	...
	static void displayLinksCount()
	{
		...
		{
			JavascriptExecutor js=(JavascriptExecutor) oBrowser;
			long Linkscounts=(long) js.executeScript("var kk=document.getElementsByTagName('A');return kk.length;");
		System.out.println("number of links"+Linkscounts);
		}
		catch(Exception e)
		{
			e.printStackTrace();
